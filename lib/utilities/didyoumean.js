    ...
    didYouMean(session) {
        ...
        bbb.createList(session, list => {
            if(!list || list.length===0) {
                ...
                fba.sendMessage(sides.pid, {recipient:{id:sides.uid},message:{text:bph.NOT_FOUND,metadata:"TEXT"}});
            }else {
                ...
                else fba.sendMessage(sides.pid, {recipient:{id:sides.uid},message:{text:bph.NOT_FOUND,metadata:"TEXT"}});
            };
        })
    }
};
